"""
Train Ordinal Regression Model for UPDRS Finger Tapping Score Prediction
...
def main():
    print("="*60)
    print("Ordinal Regression for UPDRS Finger Tapping Prediction")
    print("="*60)
    ...
    joblib.dump(ordinal_final, f"{MODEL_DIR}/ordinal_finger_tapping_scorer.pkl")
    print(f"Saved: {MODEL_DIR}/ordinal_finger_tapping_scorer.pkl")

    joblib.dump(scaler_final, f"{MODEL_DIR}/ordinal_finger_tapping_scaler.pkl")
    print(f"Saved: {MODEL_DIR}/ordinal_finger_tapping_scaler.pkl")

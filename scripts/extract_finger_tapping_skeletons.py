"""
Extract Finger Tapping 3D Skeletons from PD4T Videos
Saves as pickle files for CORAL training

Usage:
    python scripts/extract_finger_tapping_skeletons.py
"""
import os
import sys
import pickle
...
ANNOTATION_ROOT = f"{PD4T_ROOT}/Annotations/Finger tapping/stratified"
...
def main():
    print("="*60)
    print("FINGER TAPPING SKELETON EXTRACTION")
    print("="*60)
    ...
    for split in ['train', 'test']:
        ...
        # Save
        output_path = f"{OUTPUT_DIR}/finger_tapping_{split}.pkl"

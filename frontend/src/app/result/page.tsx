...
function ResultContent() {
    ...
    const skeletonVideoUrl = skeletonData?.skeleton_video_url ? apiUrl(skeletonData.skeleton_video_url) : null
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    {analysisResult.visualization_maps.heatmap_url && (
                                        <Card>
                                            ...
                                            <CardContent>
                                                <img
                                                    src={apiUrl(analysisResult.visualization_maps.heatmap_url)}
                                                    alt="Heatmap"
                                    ...
                                    {analysisResult.visualization_maps.temporal_map_url && (
                                        <Card>
                                            ...
                                            <CardContent>
                                                <img
                                                    src={apiUrl(analysisResult.visualization_maps.temporal_map_url)}
                                                    alt="Temporal Map"
                                                    className="w-full rounded-lg border"
                                                />
                                            </CardContent>
                                ...
                                <CardContent>
                                    <div className="aspect-video bg-slate-100 rounded-lg flex items-center justify-center relative overflow-hidden">
                                        {analysisResult?.visualization_urls?.heatmap ? (
                                            <img
                                                src={apiUrl(analysisResult.visualization_urls.heatmap)}
                                                alt="Heatmap"
                                ...
                                <CardContent>
                                    <div className="aspect-video bg-slate-100 rounded-lg flex items-center justify-center relative overflow-hidden">
                                        {analysisResult?.visualization_urls?.temporal_map ? (
                                            <img
                                                src={apiUrl(analysisResult.visualization_urls.temporal_map)}
                                                alt="Temporal Map"
                                                className="object-contain w-full h-full"
                                            />
                                        ) : (

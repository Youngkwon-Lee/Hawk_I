...
export function VideoPlayer({
    ...
    if (!hasVideo) {
        return (
            <div className={cn("relative rounded-xl overflow-hidden bg-black border border-border", className)}>
                <div className="relative aspect-video bg-black flex flex-col items-center justify-center gap-3 text-white/70">
                    <Activity className="h-10 w-10" />
                    <p className="text-sm font-medium">분석 영상이 없습니다</p>
                </div>
            </div>
        )
    }
